          ...
          >
            ...
            <div class="card-body p-2">
              ...
              >
                ...
                <template #priceInfo="{ item }">
                  <div>
                    <span>{{ formatPrice(item.originalPrice || item.currentPrice) }}</span>
                    <small v-if="item.priceChangeText" class="text-danger d-block">
                ...
                <template #total="{ item }">
                  <span>{{
                      formatPrice((item.originalPrice || item.currentPrice) * item.quantity)
                    }}</span>
                </template>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <input
                              ...
                              transition: all 0.3s ease;
                            "
                              :class="{ 'is-invalid': !customer.phone && formSubmitted }"
                          />
                          <div v-if="!customer.phone && formSubmitted" class="invalid-feedback">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <select
                              ...
                              transition: all 0.3s ease;
                            "
                              :class="{ 'is-invalid': !customer.city && formSubmitted }"
                          >
                          ...
                          <div v-if="!customer.city && formSubmitted" class="invalid-feedback">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <select
                              ...
                              transition: all 0.3s ease;
                            "
                              :class="{ 'is-invalid': !customer.district && formSubmitted }"
                          >
                          ...
                          <div v-if="!customer.district && formSubmitted" class="invalid-feedback">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <select
                              ...
                              transition: all 0.3s ease;
                            "
                              :class="{ 'is-invalid': !customer.ward && formSubmitted }"
                          >
                          ...
                          <div v-if="!customer.ward && formSubmitted" class="invalid-feedback">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          ...
                          <select
                              ...
                              transition: all 0.3s ease;
                            "
                              :class="{ 'is-invalid': !selectedShippingUnit && formSubmitted }"
                          >
                            <option value="" disabled>
                              Chọn đơn vị vận chuyển
                            </option>
                          ...
                          <div v-if="!selectedShippingUnit && formSubmitted" class="invalid-feedback">
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          ...
                          <input
                              ...
                              :disabled="tongTien >= FREE_SHIP_THRESHOLD"
                              min="0"
                              style="
                              border-radius: 0 8px 8px 0;
                              transition: all 0.3s ease;
                        ...
                        <div
                            v-if="tongTien >= FREE_SHIP_THRESHOLD"
                  ...
                  <div v-if="paymentMethod === 'both'" class="row g-3 mt-3">
                    <div class="col-md-6">
                      ...
                      <input
                          ...
                          min="0"
                          @input="tienChuyenKhoan = Math.max(0, tienChuyenKhoan)"
                      />
                    </div>
                    <div class="col-md-6">
                      <label class="form-label fw-medium text-dark"
                      ...
                      <input
                          ...
                          min="0"
                          @input="tienMat = Math.max(0, tienMat)"
                      />
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                          ...
                          applyPublicDiscount();
                        "
                          :disabled="tongTien < code.minOrder"
                      >
                        Áp dụng
                      </button>
                    </div>
              ...
              <div class="row g-4">
                <div class="col-md-6">
                  ...
                  <input
                      ...
                      :class="{ 'is-invalid': !newCustomer.name && formSubmitted }"
                  />
                  <div v-if="!newCustomer.name && formSubmitted" class="invalid-feedback">
                ...
                <div class="col-md-6">
                  ...
                  <input
                      ...
                      class="form-control shadow-none"
                      placeholder="Nhập số điện thoại"
                      :class="{ 'is-invalid': !newCustomer.phone && formSubmitted }"
                  />
                  <div v-if="!newCustomer.phone && formSubmitted" class="invalid-feedback">
                    Vui lòng nhập số điện thoại
                  </div>
                </div>
                <div class="col-md-6">
    ...
    ThanhToan() {
      ...
      if (this.isDelivery) {
        if (
            ...
            !this.selectedShippingUnit
        ) {
          this.$refs.notificationModal.show({
            type: "error",
            message: "Vui lòng điền đầy đủ thông tin người nhận và chọn đơn vị vận chuyển.",
          });
          return;
        }
      }
      // Proceed with payment logic
      // Assuming the original ThanhToan method handles the rest
      banHang.methods.ThanhToan.call(this);
    },
  },
});
</script>
