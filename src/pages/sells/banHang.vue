<template>
  <div class="container-fluid py-4">
        ...
        >
          <div class="order-card h-100">
            ...
            <div class="card-body p-3 pt-0 d-flex flex-column">
              ...
              <div
                v-if="cartItems.length === 0"
                class="empty-cart-message text-center py-5"
              >
                <div
                  class="empty-icon-container rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center gradient-custom-teal"
        ...
        >
          ...
          <div class="modal-body p-4">
            ...
            <div class="imei-list-container">
              ...
              <div v-else class="d-flex flex-column gap-3">
                <div
                  v-for="(item, index) in availableIMEIs"
                  :key="item.id"
                  class="imei-card p-3 rounded shadow-sm animate__animated animate__fadeInUp"
                  style="
                    background: #fff;
                ...
                >
                  ...
                  >
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      />
                      <span
                        v-if="selectedIMEIs.includes(item.imei)"
              ...
              >
                ...
                <div class="d-flex flex-column gap-3">
                  <div
                    v-for="(imei, index) in selectedIMEIs"
                    :key="imei"
                    class="imei-card p-3 rounded shadow-sm animate__animated animate__fadeInUp"
                    style="
                      background: #fff;
                  ...
                  >
                    ...
                    >
                      <div class="d-flex align-items-center">
                        ...
                        >
                        <i
                          class="bi bi-upc-scan me-2 text-teal"
                          style="font-size: 1.1rem"
                        ></i>
                      ...
                      <button
                        class="delete-imei-btn btn btn-danger btn-sm"
    ...
    >
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div
          class="modal-content shadow-lg gradient-modal"
          style="
            background: rgba(255, 255, 255, 0.95);
            backdrop-filter: blur(15px);
            border-radius: 16px;
        ...
        >
          <div
            class="modal-header border-0 d-flex justify-content-between align-items-center p-4"
          >
          ...
          <div class="modal-body p-4 discount-modal-body">
            <ul
              ...
              style="border-bottom: 2px solid rgba(52, 211, 153, 0.2)"
            >
              <li class="nav-item">
                <button
                  class="nav-link"
            ...
            <div
              ...
              class="discount-section animate__animated animate__fadeIn"
            >
              ...
              <div v-else class="row g-3">
                ...
                >
                  <div
                    class="card shadow-sm discount-card h-100 animate__animated animate__zoomIn"
                  >
                    <div
                    ...
                    >
                      ...
                      >
                        <div>
                          <h6 class="discount-code fw-bold text-teal mb-1">
                            {{ code.code }}
                          </h6>
                          <p class="mb-1">
                            Giảm
                            <span
                              class="highlight-text fw-semibold text-success"
                              >{{ formatPrice(code.value) }}</span
                            >
                          </p>
                        </div>
          ...
          <div class="modal-body p-4">
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                >
                <input
                  v-model="newCustomer.diaChiCuThe"
                  type="text"
                  class="form-control shadow-none"
