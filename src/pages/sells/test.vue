  ...
  <div class="container-fluid py-4">
    ...
    <div class="row g-4 d-flex align-items-stretch">
      <div class="col-lg-8 d-flex flex-column">
        ...
        <div class="card shadow-sm mb-4 flex-fill" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); border: none;">
          <div class="card-body p-3">
            <!-- Invoice Search -->
            <div class="search-card mb-4" style="background: linear-gradient(135deg, #60a5fa, #34d399); border-radius: 10px;">
              <div class="card-body p-3">
              ...
              <div class="bill-card" style="border-bottom-right-radius: 12px; border-bottom-left-radius: 12px;">
                <div class="card-body p-4">
                  <div class="d-flex gap-3 overflow-x-auto pb-2">
                    ...
                    >
                      <div class="card-body p-2" style="border-bottom-right-radius: 12px; border-bottom-left-radius: 12px;">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-8">
                  ...
                  <div class="d-flex flex-wrap gap-3">
                    ...
                    <span class="badge gradient-custom-teal text-white px-3 py-1">{{ formatPrice(selectedCartItem?.price) }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-content shadow-lg p-3 gradient-modal animate__animated animate__zoomIn"
          ...
          <div class="modal-body p-4">
            <div class="product-info-card mb-4 p-3 rounded shadow-sm animate__animated animate__fadeInDown"
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-8">
                  ...
                  <div class="d-flex flex-wrap gap-3">
                    <span class="badge text-white px-3 py-1" style="background-color: #1f3a44;">{{ selectedProduct?.color }}</span>
                    <span class="badge text-white px-3 py-1" style="background-color: #1f3a44;">{{ selectedProduct?.ram }}</span>
                    <span class="badge text-white px-3 py-1" style="background-color: #1f3a44;">{{ selectedProduct?.storage }}</span>
                    <span class="badge gradient-custom-teal text-white px-3 py-1">{{ formatPrice(selectedProduct?.price) }}</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="imei-list-container">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                      <input
                        ...
                        class="form-check-input me-2 imei-checkbox"
                        style="border-color: #34d399;"
              ...
              <div v-if="selectedIMEIs.length > 0" class="selected-imei-container mt-4 animate__animated animate__fadeIn">
          ...
          <div class="modal-footer border-0">
            <button
              class="btn btn-teal px-4 py-2 gradient-custom-teal text-white"
